/**
 * Ramp — native pgsql adapter (/postgres/pgsql)
 *
 * Hard cap: 10 VUs — equal to the DB pool max. Each request spawns 4
 * concurrent coroutines, so 10 VUs = 40 simultaneous pool acquires (30
 * queuing). Beyond 10 VUs coroutine count grows without throughput gain
 * and risks extension instability (see docs/load-testing/results/ramp-crash-2026-04-20.md).
 *
 * Run:
